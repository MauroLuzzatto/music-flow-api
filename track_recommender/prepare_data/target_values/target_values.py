...
def main():
    ...
    df = pd.read_csv(
        os.path.join(path_data, "streams.csv"), sep=";", usecols=["artistName", "trackName", "endTime"]
    ).rename(columns={"artistName": "artist_name", "trackName": "track_name", "endTime": "end_time"})
